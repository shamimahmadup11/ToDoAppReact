  ...
  return (
    <div className="container mx-auto px-4">
      ...
      <div className="flex justify-center mb-4">
        <input
          className="h-12 w-full md:w-1/3 bg-slate-600 rounded-md px-4"
          type="text"
      ...
      <div className="w-full md:w-2/3 mx-auto">
        <ol className="list-decimal text-white font-extrabold  text-lg">
          {todoData.map((todo, index) => (
            <div
              key={index}
              className="flex justify-center items-center space-x-4 mb-2"
            >
              <li className="bg-slate-600 rounded-md p-3 flex-1">{todo}</li>
              <button
